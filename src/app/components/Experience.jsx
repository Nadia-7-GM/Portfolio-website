...
const Experience = () => {
  ...
  boxShadow: `0 0 25px rgba(0,0,0,0.4)`,
          ...
          >
            ...
            {/* TITLE */}
            <h3 className="text-lg sm:text-xl font-bold leading-snug hover:text-green-300 transition-colors duration-300">
           ...
           <h4 className="text-xs sm:text-sm text-gray-300 mb-2">
            ...
            {/* DESCRIPTION */}
           <p className="text-[13px] sm:text-base leading-6 sm:leading-7 text-gray-400 hover:text-white transition-colors duration-300">
              {exp.summary}
            </p>
